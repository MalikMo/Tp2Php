...
<div id="page-container" class="row">
		...
		<div class="actions">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Review.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Review.id'))); ?></li> 
	...
	<div id="page-content" class="col-sm-9">
		...
		<div class="reviews form">
			...
			<?php echo $this->Form->create('Review', array('role' => 'form')); ?>
